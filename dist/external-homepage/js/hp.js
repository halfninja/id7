...
/* WEBPACK VAR INJECTION */(function(jQuery) {/*global _:false, Modernizr:false */
(function ($) {
  'use strict';
  ...
  var Config = {
    PanelsCSSTemplate: function PanelsCSSTemplate(o) {
      return 'body .id7-masthead .id7-search .fa {color: rgba(' + escapeHtml(o.colour_r) + ', ' + escapeHtml(o.colour_g) + ', ' + escapeHtml(o.colour_b) + ', 0.5);}' + 'body .id7-masthead .id7-search .twitter-typeahead:hover + .fa {color: ' + escapeHtml(o.colour) + ';}' + 'body .id7-masthead .id7-search .twitter-typeahead .tt-suggestion.tt-cursor {background: ' + escapeHtml(o.colour) + ';}' + 'body .form-control:focus {border-color: ' + escapeHtml(o.colour) + '; -webkit-box-shadow: inset 0 1px 1px rgba(0,0,0,.075), 0 0 8px rgba(' + escapeHtml(o.colour_r) + ', ' + escapeHtml(o.colour_g) + ', ' + escapeHtml(o.colour_b) + ', 0.6); box-shadow: inset 0 1px 1px rgba(0,0,0,.075), 0 0 8px rgba(' + escapeHtml(o.colour_r) + ', ' + escapeHtml(o.colour_g) + ', ' + escapeHtml(o.colour_b) + ', 0.6);}' + '.id7-page-header {background: ' + escapeHtml(o.colour) + ';}' + '.id7-masthead .id7-logo-row nav {opacity: 1; filter: alpha(opacity=100);}' + '.id7-masthead .id7-logo-row nav a {color: ' + escapeHtml(o.colour) + ' !important;}';
    },
    NavCSSTemplate: function NavCSSTemplate(o) {
      var css = '';

      _.each(o.panels, function (panel) {
        css += '.carousel-nav a[href="#' + escapeHtml(panel.id) + '"]:hover, .carousel-nav li.active a[href="#' + escapeHtml(panel.id) + '"] {color: ' + escapeHtml(panel.lighter_colour) + ';}';
      });
  ...
  var HomepageCarousel = function () {
    ...
    $.extend(HomepageCarousel.prototype, {
      wireEventHandlers: function wireEventHandlers() {
        $(window).on('resize.id7.homepage', $.proxy(this.onScreenResize, this)); // ID-30 on load (i.e. after fonts have loaded) run this, forcing a resize
      ...
      initBackgroundImages: function initBackgroundColours(isOnLoad, isDesktop) {
        var $container = this.$container;
        var options = this.options; // Background images
      ...
      initIframes: function initIframes(isOnLoad, isDesktop) {
        ...
        if (isDesktop) {
          $container.find('[data-iframe]').each(function () {
            ...
            $panel.prepend($('<div />').addClass('iframe-container').append($('<iframe />').attr({
      ...
      applyPanelStyles: function applyPanelStyles(colour) {
        var r = parseInt(colour.substring(1, 3), 16);
        var g = parseInt(colour.substring(3, 5), 16);
        var b = parseInt(colour.substring(5, 7), 16);
      ...
      onChangePanelComplete: function onChangePanelComplete($panel) {
...
/* harmony import */ var _jquery_panelSnap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./jquery.panelSnap */ "./js/external-homepage/jquery.panelSnap.js");
/* harmony import */ var _jquery_panelSnap__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_jquery_panelSnap__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _homepage_carousel_jquery__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_homepage_carousel_jquery__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _more_links_popover_jquery__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_more_links_popover_jquery__WEBPACK_IMPORTED_MODULE_2__);
/* eslint-env browser */
...
/***/ "./js/external-homepage/jquery.panelSnap.js":
/*!**************************************************!*\
  !*** ./js/external-homepage/jquery.panelSnap.js ***!
  \**************************************************/
/*! no static exports found */
...
(function ($, window, document) {
  ...
  var pluginObject = {
    ...
    bindProxied: function bindProxied($element, event, method, selector) {
      var self = this;
    ...
    destroy: function destroy() {
      var self = this; // Gotta love namespaced events!
    ...
    scrollStop: function scrollStop(e) {
      ...
      if (offset <= 0 || offset >= maxOffset) {
        ...
        self.activatePanel($target); // Set scrollOffset to a sane number for next scroll
    ...
    getPanelsInViewport: function getPanelsInViewport() {
      var self = this;
      var viewport = {
    ...
    mouseWheel: function mouseWheel() {
      var self = this; // This event only fires when the user actually scrolls with their input device.
    ...
    captureNextClick: function captureNextClick(e) {
      var self = this;
      e.preventDefault();
    ...
    capturePrevClick: function capturePrevClick(e) {
      var self = this;
      e.preventDefault();
    ...
    captureMenuClick: function captureMenuClick(e) {
      var self = this; // Use href instead of data-panel to make it easy for the homepage admins
    ...
    snapToPanel: function snapToPanel($target) {
      var self = this;
      ...
      self.$snapContainer.stop(true).delay(self.options.delay).animate({
        ...
        self.scrollOffset = self.$snapContainer.scrollTop();
        self.isSnapping = false; // Call callback
    ...
    activatePanel: function activatePanel($target) {
      var self = this;
    ...
    getPanel: function getPanel(selector) {
      var self = this;
    ...
    snapTo: function snapTo(target, wrap) {
      var self = this;
    ...
    enable: function enable() {
      var self = this; // Gather scrollOffset for next scroll
  ...
  $.fn[pluginName] = function (options) {
    ...
    return this.each(function () {
      ...
      if (_typeof(options) === 'object' || options === 'init' || !options) {
        if (!pluginInstance) {
          if (options === 'init') {
            options = args[1] || {};
          }
  ...
  $.fn[pluginName].options = {
    ...
    onSnapFinish: function onSnapFinish() {},
...
/* WEBPACK VAR INJECTION */(function(jQuery) {(function ($) {
  ...
  var Config = {
    Defaults: {
      ...
      template: ['<div class="popover megamenu-links">', '<div class="arrow"></div>', '<div class="popover-inner">', '<div class="popover-content container-fluid"></div>', '</div>', '</div>'].join('')
    }
  };
  /**
   * Display a megamenu popover
