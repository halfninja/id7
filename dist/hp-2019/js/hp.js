...
var ExpandingSearchBar =
/*#__PURE__*/
function () {
  function ExpandingSearchBar(options) {
  ...
  _createClass(ExpandingSearchBar, [{
    ...
    value: function wireEventHandlers() {
      ...
      $target.on('focus input', 'input[type="search"]', expand); // Contract when the search box is blurred or when there's a reflow

      $target.on('blur', 'input[type="search"]', contract); // When we reflow, always contract
      ...
      if (document.readyState === 'complete' && typeof jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).data('id7.reflow') !== 'undefined') {
        ...
        this.onReflow({}, Object(_screen_sizes__WEBPACK_IMPORTED_MODULE_1__["default"])());
      }
    }
  }, {
    key: "isExpanded",
    value: function isExpanded() {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(target).hasClass(className);
    }
  }, {
    key: "expand",
    ...
    key: "onReflow",
    value: function onReflow(e, screenConfig) {
...
jquery__WEBPACK_IMPORTED_MODULE_0___default.a.fn.expandingSearchBar = function initPlugin() {
  var o = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

  function attach(i, element) {
    var $trigger = jquery__WEBPACK_IMPORTED_MODULE_0___default()(element);
    var expandingSearchBar = new ExpandingSearchBar(jquery__WEBPACK_IMPORTED_MODULE_0___default.a.extend({}, $trigger.data(), o, {
      trigger: $trigger
    }));
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-toggle="id7:expanding-search-bar"]').expandingSearchBar();
});
...
/* harmony import */ var _screen_sizes__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../screen-sizes */ "./js/screen-sizes.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
