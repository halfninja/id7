...
function () {
  ...
  _createClass(Navigation, [{
    ...
    value: function affixNav() {
      ...
      var toHeadroom = $nav.affix({
        offset: {
          top: offsetTop
        }
      }).get(0);
      this.headroomNav = new Headroom(toHeadroom, headroomConfig);
      this.headroomNav.init();
    }
  }, {
    key: "fitToWidth",
    ...
    // bookmark is clicked). Unpins the header temporarily.

  }, {
    key: "hashChanged",
    value: function hashChanged() {
      var hNav = this.headroomNav;
      var hHeader = this.headroomHeader;
      setTimeout(function () {
        if (typeof hNav !== 'undefined') {
          hNav.unpin();
        }

        if (typeof hHeader !== 'undefined') {
          hHeader.unpin();
        }
      }, 1);
    }
    ...
    value: function wireEventHandlers() {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_3___default()(window).on('hashchange', jquery__WEBPACK_IMPORTED_MODULE_3___default.a.proxy(this.hashChanged, this));
    }
  }], [{
    key: "affixHeader",
    value: function affixHeader() {
      alert("Affixing header");
      var $h1 = jquery__WEBPACK_IMPORTED_MODULE_3___default()('.id7-header-text h1');
      ...
      if ($h1.length) {
        ...
        alert("Setting this.headroomHeader");
        this.headroomHeader = new Headroom(affix.get(0), headroomConfig);
        this.headroomHeader.init();
      }
    }
  }, {
