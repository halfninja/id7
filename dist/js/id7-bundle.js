...
jquery__WEBPACK_IMPORTED_MODULE_1___default.a.fn.goSearchSuggest = function goSearchSuggestPlugin() {
  ...
  function attach(i, el) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()(el).next('.fa').on('click', function (e) {
      e.preventDefault();
      e.stopPropagation();
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()(el).searchSuggest(jquery__WEBPACK_IMPORTED_MODULE_1___default.a.extend(options, {
