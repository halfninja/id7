...
jquery__WEBPACK_IMPORTED_MODULE_0___default.a.fn.dropdown.Constructor.prototype.keydown = function (e) {
  if (!(/(38|40|27|32)/.test(e.which) && (e.which < 65 || e.which > 90)) || /input|textarea/i.test(e.target.tagName)) return;
