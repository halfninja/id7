...
function () {
  ...
  _createClass(Navigation, [{
    ...
    key: "scrollFired",
    value: function scrollFired() {
      console.log("Scroll has fired " + new Date().getMilliseconds());
    }
  }, {
    ...
    value: function wireEventHandlers() {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_3___default()(window).on('scroll', jquery__WEBPACK_IMPORTED_MODULE_3___default.a.proxy(this.scrollFired, this));
    }
  }], [{
    key: "affixHeader",
...
jquery__WEBPACK_IMPORTED_MODULE_3___default()(function () {
  jquery__WEBPACK_IMPORTED_MODULE_3___default()('.id7-navigation').id7Navigation(); // jump to a tab if specified
