...
jquery__WEBPACK_IMPORTED_MODULE_0___default.a.fn.dropdown.Constructor.prototype.keydown = function (e) {
  ...
  if (e.which === 38 && index > 0) _readOnlyError("index"), index--; // up

  if (e.which === 40 && index < $items.length - 1) _readOnlyError("index"), index++; // down

  if (!~index) index = (_readOnlyError("index"), 0);
